...
plecakdb <- data.frame(
  przedmiot = c("zegar", "obraz-pejzaż",
                "obraz-portret", "radio", "laptop", "lampka nocna", "srebrne sztućce", 
...
bestChromosome = c(0, 1, 1, 0, 1, 0, 1, 1, 0, 1, 0 )
plecakdb[bestChromosome == 1, ]
cat(bestChromosome %*% plecakdb$wartosc)
cat(bestChromosome %*% plecakdb$waga)
plecakGenAlg